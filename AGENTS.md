...
- **Zero Dark Container & Table Badge Leak Guardrail (WCAG AAA 7:1 Minimum)**: Table badges and currency pills MUST enforce high-contrast light theme classes (`bg-blue-50 text-blue-950 border border-blue-300 font-black`, `bg-emerald-50 text-emerald-950 border border-emerald-300 font-black`). Dark background pills (`dark:bg-slate-700`) with dark/primary text are strictly forbidden.
