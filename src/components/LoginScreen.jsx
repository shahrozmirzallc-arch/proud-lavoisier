...
export default function LoginScreen({ onSignedIn, onResetPassword, demoEnabled = false }) {
    ...
    <main className="login-shell">
      ...
      <section className="login-form-panel">
        <div className="login-card">
          ...
          {/* Quick 1-Click Login Shortcuts (Shown ONLY when VITE_DEMO_MODE is true) */}
          {demoEnabled && (
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                <button
                  ...
                  onClick={async () => {
                    ...
                    setSubmitting(true);
                    try {
                      const res = await onSignedIn({ username: 'customer', isDemoMode: true });
