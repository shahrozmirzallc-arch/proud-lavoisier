            ...
            <div>
              ...
              <div className="mt-3 bg-white border border-slate-300 rounded-lg p-3 flex flex-col gap-3 shadow-sm">
                ...
                {bonusTasks && bonusTasks.length > 0 && (
                  <div className="bg-amber-50/80 border border-amber-300/80 rounded-lg p-2.5 flex flex-col gap-2 shadow-xs mt-1 text-left">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-[8.5px] bg-amber-200 text-amber-900 px-1.5 py-0.5 rounded font-black uppercase tracking-wider">
                        Assigned Task
                      </span>
                    </div>
                    ...
                    <div className="flex flex-col gap-1.5">
                      {bonusTasks.map((task) => (
                        <div key={task.id} className="bg-white border border-amber-200 rounded-md p-2 flex items-center justify-between shadow-2xs">
                          <div className="flex flex-col text-left pr-2">
                            <span className="text-[11px] font-extrabold text-slate-900 leading-tight">{task.task}</span>
                            <span className="text-[9px] text-amber-800 font-bold mt-0.5 flex items-center gap-1">
